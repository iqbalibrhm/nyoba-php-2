    ...
    <table border="15" align="left" cellpadding="20" width="10%" cellspacing="5">
        ...
        <thead>
            <tr bgcolor="darkblue" align="center" length="50" font color="white">
                <th colspan="5" color="white"><font color="white">IqbalPedia </th></font> 
            </tr>
                ...
                <td>
                    ...
                    <tr> 
                            ...
                            <td>
                             ...
                             <input type="radio" value="Katholik" name="agama"> Katholik
...
if($jabatan == "manager"){
    $gaji= 14000000;
    $tunjangan= 14000000 * 20/100;
    
}
else if($jabatan == "Software Engineer"){
    $gaji= 8200000;
    $tunjangan= 8200000 * 20/100;
}
else if($jabatan == "Customer Service"){
    $gaji= 5400000;
    $tunjangan= 5400000 * 20/100; 
}
...
@$zakat = ($agama == 'Islam' && $gaji >= 35000) ? 2.5/100 * ($gaji+$tunjangan+$tunjangankel+$tunjangananak)  : 0;
