...
<body>
  ...
  <div class="container">    
    <form class="form-horizontal p-5 shadow" style="background-color:#f1f2f6;" method="GET" action="input_nilai.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-7">
            <select name="mata__kuliah" class="form-control">
              <option value="DDP">Lainnya</option>
              <option value="DDP">UI/UX</option>
              <option value="PWL">Basis Data</option>
              <option value="BD">Pemrograman Web</option>
            </select>
          </div>
        </div>
        <br>
